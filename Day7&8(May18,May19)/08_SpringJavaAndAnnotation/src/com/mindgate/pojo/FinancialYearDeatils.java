...
@Scope("prototype")
public class FinancialYearDeatils {
	private int yearId;
	private LocalDate yearStartDate;
	private LocalDate yearEndDate;
	
	public FinancialYearDeatils() {
		// TODO Auto-generated constructor stub
	}

	public FinancialYearDeatils(int yearId, LocalDate yearStartDate, LocalDate yearEndDate) {
		super();
		this.yearId = yearId;
	...
	public String toString() {
		return "FinancialYearDeatils [yearId=" + yearId + ", yearStartDate=" + yearStartDate + ", yearEndDate="
				+ yearEndDate + "]";
	}
